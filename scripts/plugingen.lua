...
void
dmz::$(NAME)::update_event_object_handle (
      const Handle EventHandle,
      const Handle AttributeHandle,
      const Handle Value) {
...
void
dmz::$(NAME)::update_event_object_type (
      const Handle EventHandle,
      const Handle AttributeHandle,
      const ObjectType &Value) {
...
void
dmz::$(NAME)::update_event_time_stamp (
      const Handle EventHandle,
      const Handle AttributeHandle,
      const Float64 &Value) {
...
void
dmz::$(NAME)::update_event_position (
      const Handle EventHandle,
      const Handle AttributeHandle,
      const Vector &Value) {
...
void
dmz::$(NAME)::update_event_orientation (
      const Handle EventHandle,
      const Handle AttributeHandle,
      const Matrix &Value) {
...
void
dmz::$(NAME)::update_event_velocity (
      const Handle EventHandle,
      const Handle AttributeHandle,
      const Vector &Value) {
...
void
dmz::$(NAME)::update_event_acceleration (
      const Handle EventHandle,
      const Handle AttributeHandle,
      const Vector &Value) {
